 ...
 */
package bhaashik.mlearning.svm;
...
import bhaashik.formats.converters.SSF2SVM;
import bhaashik.formats.converters.SVM2SSF;
 ...
 * @author anil
 */
public class SVMAnnotationMain extends DefaultAnnotationMain implements BhaashikAnnotationMain {
...
//        svmAnnotation.trainDataPaths[0] = new File("/home/anil/projects/bhaash/bhaash-release/public/git/Bhaashik/data/automatic-annotation/pos-tagging/testing/story_27_1.final.mod.utf8-5.out.txt");
