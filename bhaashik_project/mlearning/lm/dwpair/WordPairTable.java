package bhaashik.mlearning.lm.dwpair;
...
import bhaashik.corpus.simple.data.impl.WordTypeImpl;
import bhaashik.corpus.simple.data.impl.WordTypeTableImpl;
...
import bhaashik.corpus.simple.data.WordTypeTable;
import bhaashik.corpus.simple.impl.SimpleCorpusImpl;
import bhaashik.corpus.simple.impl.SimpleSentenceImpl;
...
public class WordPairTable
{
	...
	public void resetHash()
	{
		for(int i = 0; i < countWPs(); i++)
		{
			...
			index.put(key,Integer.valueOf(in));
		}
	}
