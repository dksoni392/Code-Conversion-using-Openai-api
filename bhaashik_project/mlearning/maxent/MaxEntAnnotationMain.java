 ...
 */
package bhaashik.mlearning.maxent;

import bhaashik.corpus.ssf.impl.SSFStoryImpl;
import bhaashik.formats.converters.MaxEnt2SSF;
import bhaashik.formats.converters.SSF2MaxEnt;
...
import bhaashik.annotation.DefaultAnnotationMain;
import bhaashik.annotation.BhaashikAnnotationMain;
 ...
 */
public class MaxEntAnnotationMain extends DefaultAnnotationMain implements BhaashikAnnotationMain {
...
//        PrintStream resultOP1 = new PrintStream("C:\\Users\\Sourabh\\Desktop\\Bhaashik data\\sourabh.out.utf8");
...
//            ChunkerME treebankChunker = new ChunkerME(getGISModel(), dcg);
            //PrintStream faltu = new PrintStream("C:\\Users\\Sourabh\\Desktop\\Bhaashik data\\faltu.utf8");
