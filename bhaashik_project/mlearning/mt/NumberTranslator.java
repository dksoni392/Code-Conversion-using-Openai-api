...
import bhaashik.filters.NumberFilter;
...
public class NumberTranslator
{
    ...
    public NumberTranslator(String srcLangEnc, String srcCharset, String tgtLangEnc, String tgtCharset)
    {
        ...
        String srcLangCode = BhaashikLanguages.getLanguageCodeFromLECode(srcLangEnc);
        String tgtLangCode = BhaashikLanguages.getLanguageCodeFromLECode(tgtLangEnc);
