...
//    protected String tgtPath = GlobalProperties.getHomeDirectory() + "/" + "data/transliteration/translit-test-data-hindi-smt-results.xml";
            ...
            String inPathORString, boolean onlyTheFirst, boolean outputXML, String outPath)
    {
        ...
        String srcLang = BhaashikLanguages.getLanguageCodeFromLECode(srcLangEnc);
        String tgtLang = BhaashikLanguages.getLanguageCodeFromLECode(tgtLangEnc);
...
//        SMTTransliterator transliterator = new SMTTransliterator(GlobalProperties.getHomeDirectory() + "/data/transliteration/en-hi-utf8/phramer.fast.ini");
        ...
        if(args.length < 4)
        {
            ...
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator mode srcLangEnc tgtLangEnc inputStringORFile  [onlyTheFirst] [[xml] [outFilePath]]]");
            System.out.println("Examples:");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -s eng::utf8 hin::utf8 kandarp");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -s eng::utf8 hin::utf8 kandarp false false out.xml");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -s eng::utf8 hin::utf8 kandarp false true out.xml");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -f eng::utf8 hin::utf8 in.txt");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -f eng::utf8 hin::utf8 in.txt false true out.xml");
            System.out.println("\tjava -cp ... bhaash.mt.mlearning.bhaash.SMTTransliterator -f eng::utf8 hin::utf8 in.txt false false out.xml");
