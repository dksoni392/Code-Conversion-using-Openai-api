...
import bhaashik.mlearning.maxent.MaxEntAnnotationMain;
import bhaashik.mlearning.svm.SVMAnnotationMain;
import bhaashik.mlearning.weka.WekaAnnotationMain;
...
public class AutomaticAnnotationJPanel extends javax.swing.JPanel
    implements BhaashikClient, JPanelDialog {
    ...
    {
        BhaashikJDialog fsDialog = (BhaashikJDialog) DialogFactory.showDialog(FileSelectionJPanel.class, owner, GlobalProperties.getIntlString("Select_Files"), true);
