...
public class SubApplicationDescriptionJDialog extends javax.swing.JDialog {
    ...
    public SubApplicationDescriptionJDialog(java.awt.Frame parent, boolean modal) {
        ...
        setTitle(GlobalProperties.getIntlString("About_a_Bhaashik_Application"));

        BufferedImage image = null;

        try {
            image = javax.imageio.ImageIO.read(new File(GlobalProperties.getHomeDirectory() + "/" + "images/bhaash-logo.gif"));
        ...
        ImageIcon icon = new ImageIcon(image, GlobalProperties.getIntlString("Bhaashik"));
...
//    {
        ...
        java.util.ResourceBundle bundle = java.util.ResourceBundle.getBundle("bhaash/gui/clients/applicationDescription"); // NOI18N
        ...
        */
        ...
        //String showThis=runClientJComboBox.getItemAt(selected).applicationDescription();
          ...
          //ApplicationDescription appl=(ApplicationDescription)temp.createBhaashikClient(temp);
