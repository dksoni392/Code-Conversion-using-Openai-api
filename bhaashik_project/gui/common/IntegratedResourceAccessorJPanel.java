...
import bhaashik.corpus.manager.gui.KwikJPanel;
import bhaashik.gui.actions.FindReplaceAction;
 ...
 * @author  anil
 */
public class IntegratedResourceAccessorJPanel extends javax.swing.JPanel implements BhaashikClient, JPanelDialog {
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout commonCorpusOptionsJPanelLayout = new javax.swing.GroupLayout(commonCorpusOptionsJPanel);
        commonCorpusOptionsJPanel.setLayout(commonCorpusOptionsJPanelLayout);
        commonCorpusOptionsJPanelLayout.setHorizontalGroup(
            commonCorpusOptionsJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
 ...
 */
	...
	if(findReplaceOptions.batchMode || findReplaceOptions.standAlone)
	{
	    ...
	    findReplaceOptions.language = BhaashikLanguages.getLangEncCode(findReplaceOptions.language);
	}
	else
	{
	    if(contentJPanel instanceof TextEditorJPanel)
...
//            fileListJList.setModel(fileList);
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(GlobalProperties.getIntlString("Bhaashik_Find_Replace_Tool"));
