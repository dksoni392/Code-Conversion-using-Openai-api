...
public class BhaashikCharmapJPanel extends javax.swing.JPanel
    ...
    protected ClientType clientType = ClientType.BHAASHIK_CHARMAP;
...
//        }
    ...
    private static void saveState(BhaashikCharmapJPanel editorInstance) {
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.BHAASHIK_CHARMAP.toString());
