...
public class FontChooser extends javax.swing.JDialog implements ActionListener {
	...
	String eCode = BhaashikLanguages.getEncodingCodeFromLECode(langEnc);
	
	String langName = BhaashikLanguages.getLanguageName(lCode);
	String encName = BhaashikLanguages.getEncodingName(eCode);
	...
	BhaashikLanguages.fillFonts(fontFamilies, langEncCode, allSystemFonts.isSelected());
	fontName.setModel(fontFamilies);

	fontSizes = new DefaultComboBoxModel();
	BhaashikLanguages.fillFontSizes(fontSizes, 4, 64, 2);
...
// TODO add your handling code here:
	...
	if(BhaashikLanguages.findSystemFont(name) != null)
	{
	...
	{
	    fnt = BhaashikLanguages.getFont(name);
