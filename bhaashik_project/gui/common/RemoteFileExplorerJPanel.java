...
import bhaashik.tree.gui.AdapterTreeJPanel;
import bhaashik.server.dto.utils.BhaashikServerFileUtils;
 ...
 * @author anil
 */
public class RemoteFileExplorerJPanel extends AdapterTreeJPanel implements JPanelDialog, BhaashikClient {
...
//        }
    ...
    {
        BhaashikServerFileUtils.sortTree(getJTree().getModel(), rootRemoteFileNode);
    }
