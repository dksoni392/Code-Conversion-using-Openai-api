...
public class KeystrokeCellEditor extends AbstractCellEditor
    ...
    protected BhaashikTableModel currentTable;
...
//            button.setText(currentLabel);
            ...
            BhaashikJDialog dlg = new BhaashikJDialog((Frame) owner, "Edit Keystroke", true, keystrokeEditorJPanel);
            dlg.pack();
...
//        button.setText(getKeyStrokeLabel(currentValue));
        ...
        currentTable = (BhaashikTableModel) table.getModel();
