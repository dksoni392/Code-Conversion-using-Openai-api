...
import bhaashik.gui.console.JTextConsole;
...
//            return false;
	...
	protected void processKeyEvent(KeyEvent e) {
		...
		if (keyCode == KeyEvent.VK_ENTER && e.getID() == KeyEvent.KEY_PRESSED) {
            fireBhaashikShellEvent(new BhaashikShellEvent(this, BhaashikShellEvent.SHELL_COMMAND_EVENT));
...
//				}
    ...
    public void addBhaashikShellEventListener(EventListener listener)
    {
        listenerList.add(EventListener.class, listener);
    }

    // This methods allows classes to unregister for MyEvents
    public void removeBhaashikShellEventListener(EventListener listener)
    {
        listenerList.remove(EventListener.class, listener);
    }

    // This private class is used to fire BhaashikShellEvent
    public void fireBhaashikShellEvent(BhaashikShellEvent evt)
    {
        ...
        {
            if (listeners[i] instanceof BhaashikShellEventListener)
            {
                ((BhaashikShellEventListener) listeners[i]).handledShellEvent((BhaashikShellEvent) evt);
            }
        }
    }
