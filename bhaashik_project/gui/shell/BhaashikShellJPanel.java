...
public class BhaashikShellJPanel extends javax.swing.JPanel
    ...
    protected ClientType clientType = ClientType.BHAASHIK_SHELL;
...
//            jMathLibInterpreter = new jmathlib.core.jMathLibInterpreter.Interpreter(false);
    ...
    //                    output += curFile.getAbsolutePath() + "\n";
            ...
            {
                ((BhaashikMain) owner).createNewApplication(ClientType.BHAASHIK_EDITOR);
            }
    ...
    //                process = null;
            ...
            {
                ((BhaashikMain) owner).createNewApplication(ClientType.BHAASHIK_SHELL);
            }
            else if(cmd.startsWith("new "))
            {
                ...
                else if(parts.length == 2)
                {
                    ...
                    if(modeStr.equals("math"))
                    {
                        ...
                        BhaashikClient client = ((BhaashikMain) owner).createNewApplication(ClientType.BHAASHIK_SHELL);
