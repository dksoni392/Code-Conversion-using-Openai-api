 ...
 * @author anil
 */
public class BhaashikConsoleReader implements ConsoleOperations {
    ...
    /**
     * Map that contains the operation name to keymap operation mapping.
     */
    ...
    static {
        ...
        names.put("MOVE_TO_BEG", Short.valueOf(MOVE_TO_BEG));
        names.put("MOVE_TO_END", Short.valueOf(MOVE_TO_END));
        names.put("PREV_CHAR", Short.valueOf(PREV_CHAR));
        names.put("NEWLINE", Short.valueOf(NEWLINE));
        names.put("KILL_LINE", Short.valueOf(KILL_LINE));
        names.put("PASTE", Short.valueOf(PASTE));
        names.put("CLEAR_SCREEN", Short.valueOf(CLEAR_SCREEN));
        names.put("NEXT_HISTORY", Short.valueOf(NEXT_HISTORY));
        names.put("PREV_HISTORY", Short.valueOf(PREV_HISTORY));
        names.put("START_OF_HISTORY", Short.valueOf(START_OF_HISTORY));
        names.put("END_OF_HISTORY", Short.valueOf(END_OF_HISTORY));
        names.put("REDISPLAY", Short.valueOf(REDISPLAY));
        names.put("KILL_LINE_PREV", Short.valueOf(KILL_LINE_PREV));
        names.put("DELETE_PREV_WORD", Short.valueOf(DELETE_PREV_WORD));
        names.put("NEXT_CHAR", Short.valueOf(NEXT_CHAR));
        names.put("REPEAT_PREV_CHAR", Short.valueOf(REPEAT_PREV_CHAR));
        names.put("SEARCH_PREV", Short.valueOf(SEARCH_PREV));
        names.put("REPEAT_NEXT_CHAR", Short.valueOf(REPEAT_NEXT_CHAR));
        names.put("SEARCH_NEXT", Short.valueOf(SEARCH_NEXT));
        names.put("PREV_SPACE_WORD", Short.valueOf(PREV_SPACE_WORD));
        names.put("TO_END_WORD", Short.valueOf(TO_END_WORD));
        names.put("REPEAT_SEARCH_PREV", Short.valueOf(REPEAT_SEARCH_PREV));
        names.put("PASTE_PREV", Short.valueOf(PASTE_PREV));
        names.put("REPLACE_MODE", Short.valueOf(REPLACE_MODE));
        names.put("SUBSTITUTE_LINE", Short.valueOf(SUBSTITUTE_LINE));
        names.put("TO_PREV_CHAR", Short.valueOf(TO_PREV_CHAR));
        names.put("NEXT_SPACE_WORD", Short.valueOf(NEXT_SPACE_WORD));
        names.put("DELETE_PREV_CHAR", Short.valueOf(DELETE_PREV_CHAR));
        names.put("ADD", Short.valueOf(ADD));
        names.put("PREV_WORD", Short.valueOf(PREV_WORD));
        names.put("CHANGE_META", Short.valueOf(CHANGE_META));
        names.put("DELETE_META", Short.valueOf(DELETE_META));
        names.put("END_WORD", Short.valueOf(END_WORD));
        names.put("NEXT_CHAR", Short.valueOf(NEXT_CHAR));
        names.put("INSERT", Short.valueOf(INSERT));
        names.put("REPEAT_SEARCH_NEXT", Short.valueOf(REPEAT_SEARCH_NEXT));
        names.put("PASTE_NEXT", Short.valueOf(PASTE_NEXT));
        names.put("REPLACE_CHAR", Short.valueOf(REPLACE_CHAR));
        names.put("SUBSTITUTE_CHAR", Short.valueOf(SUBSTITUTE_CHAR));
        names.put("TO_NEXT_CHAR", Short.valueOf(TO_NEXT_CHAR));
        names.put("UNDO", Short.valueOf(UNDO));
        names.put("NEXT_WORD", Short.valueOf(NEXT_WORD));
        names.put("DELETE_NEXT_CHAR", Short.valueOf(DELETE_NEXT_CHAR));
        names.put("CHANGE_CASE", Short.valueOf(CHANGE_CASE));
        names.put("COMPLETE", Short.valueOf(COMPLETE));
        names.put("EXIT", Short.valueOf(EXIT));
        names.put("CLEAR_LINE", Short.valueOf(CLEAR_LINE));
     ...
     * The null mask.
     */
    private static final Character NULL_MASK = Character.valueOf((char) 0);
     ...
     * The Terminal to use.
     */
    private final BhaashikTerminal terminal;

//    private CompletionHandler completionHandler = new CandidateListCompletionHandler();
    private CompletionHandler completionHandler = new BhaashikCompletionHandler();
...
//    InputStream in;
	...
	public void addTriggeredAction(char c, ActionListener listener){
		triggeredActions.put(Character.valueOf(c), listener);
	}
     ...
     */
    public BhaashikConsoleReader() throws IOException {
     ...
     */
    public BhaashikConsoleReader(final InputStream in, final Writer out)
            throws IOException {
        this(in, out, null);
    }
    ...
    public BhaashikConsoleReader(final InputStream in, final Writer out,
        ...
        this(in, out, bindings, (BhaashikTerminal) BhaashikTerminal.getTerminal());
    }
     ...
     *            the terminal to use
     */
    public BhaashikConsoleReader(InputStream in, Writer out, InputStream bindings,
            BhaashikTerminal term) throws IOException {
        this.terminal = term;
    ...
    public BhaashikTerminal getTerminal() {
    ...
    public void setDebug(final PrintWriter debugger) {
        BhaashikConsoleReader.debugger = debugger;
    }
		    ...
		    break;
                ...
                default:
                    if (c != 0) { // ignore null chars
                    	ActionListener action = (ActionListener) triggeredActions.get(Character.valueOf((char)c));
                    	if (action != null)
...
//    }
    ...
    private final boolean complete() throws IOException {
        ...
        return ((BhaashikCompletionHandler) completionHandler).complete(this, candidates, position);
    }
