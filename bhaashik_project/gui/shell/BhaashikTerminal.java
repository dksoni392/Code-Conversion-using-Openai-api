 ...
 * @author anil
 */
public class BhaashikTerminal extends Terminal implements ConsoleOperations {
    ...
    public void beforeReadLine(BhaashikConsoleReader reader, String prompt,
                               Character mask) {
    }

    public void afterReadLine(BhaashikConsoleReader reader, String prompt,
                              Character mask) {
    }
