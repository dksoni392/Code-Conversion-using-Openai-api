 ...
 * @author anil
 */
public class BhaashikShellReaderThread extends Thread
{
    ...
    public BhaashikShellReaderThread(PipedInputStream pi, JTextShell textShell, BhaashikShellJPanel bhaashikShellJPanel)
    {
        this.pi = pi;
