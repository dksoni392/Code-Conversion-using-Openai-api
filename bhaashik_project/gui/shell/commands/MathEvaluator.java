...
public class MathEvaluator
{
    ...
    private static Double evaluateExpression(Operator o, Double f1, Double f2)
    {
        ...
        if  	 ( "+".equals(op) ) 	res = Double.valueOf( f1.doubleValue() + f2.doubleValue() );
        else if  ( "-".equals(op) ) 	res = Double.valueOf( f1.doubleValue() - f2.doubleValue() );
        else if  ( "*".equals(op) ) 	res = Double.valueOf( f1.doubleValue() * f2.doubleValue() );
        else if  ( "/".equals(op) )  	res = Double.valueOf( f1.doubleValue() / f2.doubleValue() );
        else if  ( "^".equals(op) )  	res = Double.valueOf( Math.pow(f1.doubleValue(), f2.doubleValue()) );
        else if  ( "%".equals(op) )  	res = Double.valueOf( f1.doubleValue() % f2.doubleValue() );
        else if  ( "&".equals(op) )  	res = Double.valueOf( f1.doubleValue() + f2.doubleValue() ); // todo
        else if  ( "|".equals(op) )  	res = Double.valueOf( f1.doubleValue() + f2.doubleValue() ); // todo
        else if  ( "cos".equals(op) )  	res = Double.valueOf( Math.cos(f1.doubleValue()) );
        else if  ( "sin".equals(op) )  	res = Double.valueOf( Math.sin(f1.doubleValue()) );
        else if  ( "tan".equals(op) )  	res = Double.valueOf( Math.tan(f1.doubleValue()) );
        else if  ( "acos".equals(op) )  res = Double.valueOf( Math.acos(f1.doubleValue()) );
        else if  ( "asin".equals(op) )  res = Double.valueOf( Math.asin(f1.doubleValue()) );
        else if  ( "atan".equals(op) )  res = Double.valueOf( Math.atan(f1.doubleValue()) );
        else if  ( "sqr".equals(op) )  	res = Double.valueOf( f1.doubleValue() * f1.doubleValue() );
        else if  ( "sqrt".equals(op) )  res = Double.valueOf( Math.sqrt(f1.doubleValue()) );
        else if  ( "log".equals(op) )  	res = Double.valueOf( Math.log(f1.doubleValue()) );
        else if  ( "min".equals(op) )  	res = Double.valueOf( Math.min(f1.doubleValue(), f2.doubleValue()) );
        else if  ( "max".equals(op) )  	res = Double.valueOf( Math.max(f1.doubleValue(), f2.doubleValue()) );
        else if  ( "exp".equals(op) )  	res = Double.valueOf( Math.exp(f1.doubleValue()) );
        else if  ( "floor".equals(op) ) res = Double.valueOf( Math.floor(f1.doubleValue()) );
        else if  ( "ceil".equals(op) )  res = Double.valueOf( Math.ceil(f1.doubleValue()) );
        else if  ( "abs".equals(op) )  	res = Double.valueOf( Math.abs(f1.doubleValue()) );
        else if  ( "neg".equals(op) )  	res = Double.valueOf( - f1.doubleValue() );
        else if  ( "rnd".equals(op) ) 	res = Double.valueOf( Math.random() * f1.doubleValue() );
