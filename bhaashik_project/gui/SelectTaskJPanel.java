...
import bhaashik.corpus.parallel.gui.ParallelMarkupAnalyzerJPanel;
import bhaashik.corpus.parallel.gui.ParallelMarkupTaskSetupJPanel;
import bhaashik.corpus.parallel.gui.ParallelMarkupWorkJPanel;
import bhaashik.corpus.ssf.gui.SSFCorpusAnalyzerJPanel;
...
import bhaashik.gui.common.GenerateTasksJPanel;
...
// TODO add your handling code here:
        BhaashikJDialog gtDialog = (BhaashikJDialog) DialogFactory.showDialog(GenerateTasksJPanel.class, owner, "GenerateTasksJPanel", true);
...
// TODO add your handling code here:
	...
	else if(taskType == PARALLEL_MARKUP_TASK)
	{
        ...
        ((BhaashikClient) annotationClient).setOwner(this.getOwner());
...
// TODO add your handling code here:
        ...
        try
        {
            ...
            ((BhaashikClient) taskJPanel).setOwner(this.getOwner());
    ...
    //            annotationClient = new SenAlignWorkJPanel();
            ...
            ((BhaashikClient) annotationClient).setOwner(owner);
            ((JPanelDialog) annotationClient).setDialog(workDialog);
            ((WorkJPanelInterface) annotationClient).setTaskName(taskName);
            ((WorkJPanelInterface) annotationClient).configure();
