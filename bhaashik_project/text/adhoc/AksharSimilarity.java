...
import bhaashik.text.AksharData;
...
public class AksharSimilarity
{
	...
	double getAksharCost(String aks1, String aks2, PhoneticModelOfScripts phModel)
	{
		...
		Character cha1 = Character.valueOf(c1);
		Character cha2 = Character.valueOf(c2);
	...
	public static void main (String[] args)
	{
		try
		{
			...
			a.readScript("/home/bhaash/tmp/devType.txt");
			a.makeGrammar();
			a.readDictionary("/home/bhaash/Hindi");
			//a.readDictionary("/home/bhaash/tmp/dictList");
			aks.generateSimTest(a, 0, model);
			aks.generateSimList(a,model);
			//aks.writeSimilarityList("/home/bhaash/tmp/AksharSimList");
			//aks.readSimilarityList("/home/bhaash/tmp/AksharSimListFinal");
			System.out.println(GlobalProperties.getIntlString("writen"));
			aks.writeSimilarityList("/home/bhaash/tmp/ILIEngSimList");
		}
		catch (Exception ex)
		{
			ex.printStackTrace();
