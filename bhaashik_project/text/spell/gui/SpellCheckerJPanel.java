...
import bhaashik.gui.actions.SpellCheckerAction;
import bhaashik.gui.clients.BhaashikClient;
import bhaashik.gui.common.ExitListener;
import bhaashik.gui.common.JPanelDialog;
import bhaashik.text.spell.SpellChecker;
import bhaashik.text.spell.SpellCheckerOptions;
import bhaashik.util.FileSplitter;
 ...
 * @author  anil
 */
public class SpellCheckerJPanel extends javax.swing.JPanel implements JPanelDialog, BhaashikClient {
...
//			}
    ...
    private void initLanguage() {
        if(spellCheckerOptions.batchMode || spellCheckerOptions.standAlone) {
            ...
            spellCheckerOptions.language = BhaashikLanguages.getLangEncCode(spellCheckerOptions.language);
        } else {
    ...
    private static void createAndShowGUI() {
        ...
        JFrame frame = new JFrame(GlobalProperties.getIntlString("Bhaashik_Spell_Checker"));
