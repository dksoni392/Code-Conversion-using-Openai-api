...
public class TextEditorJPanel extends javax.swing.JPanel implements WindowListener, FileDisplayer, BhaashikClient, JPanelDialog {
    ...
    protected ClientType clientType = ClientType.BHAASHIK_EDITOR;
...
//        displayFileInBackground(new File(path), charset, e);
    ...
    public void setTitle(String t) {
        ...
        String fullTitle = GlobalProperties.getIntlString("Bhaashik:_") + ClientType.BHAASHIK_EDITOR.toString() + GlobalProperties.getIntlString(":_") + title;
...
//        editorJPopupMenu.removeMouseListener(popupListener);
    ...
    private static void saveState(TextEditorJPanel editorInstance) {
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.BHAASHIK_EDITOR.toString());
