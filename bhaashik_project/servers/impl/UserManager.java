...
import bhaashik.common.types.UserType;
 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class UserManager extends BhaashikServer
    implements UserManagerRI, Serializable
{
    ...
    public UserManager(String propManPath, String cs, BhaashikMainServer bhaashikMainServer) throws RemoteException, IOException
    {
	...
	if(user.equals("") || user.equalsIgnoreCase(UserType.ANONYMOUS.toString()))
        ...
        users.put((user), Integer.valueOf(1));
...
//    }
    ...
    public final static UserManager getUserManagerServerInstance(String propManPath, String cs, BhaashikMainServer bhaashikMainServer)
    {
        UserManager userManagerServer = null;
        
        try {
            userManagerServer = new UserManager(propManPath, cs, bhaashikMainServer);
        } catch (IOException ex) {
