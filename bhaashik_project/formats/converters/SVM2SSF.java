...
import bhaashik.mlearning.svm.DefaultSVMData;
...
public class SVM2SSF extends DefaultMLCorpusConverter implements MLCorpusConverter
{
 ...
 /*   public void init(File ssfFiles[], String mlPath, String cs, String opath, String labelFeature)
    ...
    protected void convertToTagFormat(boolean featureType)
    {
       ...
       DefaultSVMData.DefaultSVMDocument doc = null;
     ...
     protected void convertToChunkFormatBIESO(boolean featureType, boolean preserveChunkBoundaries)
    {
        ...
        for(int i = 0; ( i < scount || scount == 0 ); i++)
        {
            ...
            DefaultSVMData.DefaultSVMDocument doc = ((DefaultSVMData) mlCorpus).getDocument(0);
    ...
    protected void addStory(DefaultSVMData.DefaultSVMDocument doc, SSFStory ssfStory)
    {    
...
//                "ne");
//        svm2ssf.labels.getInt2LabelMapping().read("/media/disk/Users/53590/Desktop/IIIT H/Bhaashik/Bhaashik new version/Bhaashik-17-05-09/data/automatic-annotation/SVM_Pos-tagging/17-06-labels.txt",
//                GlobalProperties.getIntlString("UTF-8"));
