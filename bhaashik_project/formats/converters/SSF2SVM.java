...
import bhaashik.mlearning.svm.SVMExtractFeatures;
    ...
    protected void convertToChunkFormat(boolean featureType, boolean preserveChunkBoundaries) {
        ...
        while (enm.hasMoreElements()) {
            ...
            for (int i = 0; i < scount; i++) {
                ...
                List<BhaashikMutableTreeNode> words = root.getAllLeaves();
...
//                "/media/disk/Users/53590/Desktop/IIIT H/Bhaashik/Bhaashik new version/Bhaashik-17-05-09/data/automatic-annotation/SVM_Pos-tagging/svm-train.txt",
//                GlobalProperties.getIntlString("UTF-8"),
//                "/media/disk/Users/53590/Desktop/IIIT H/test/svm/learnt model/potagging_linear_kernel",
//                "ne");
//        /*ssf2svm.labels.getInt2LabelMapping().read("/media/disk/Users/53590/Desktop/IIIT H/Bhaashik/Bhaashik new version/Bhaashik-17-05-09/data/automatic-annotation/pos-tagging/learntModels/labels",
//         "UTF-8");*/
//        ssf2svm.convert(CHUNK_FORMAT);
//        ssf2svm.labels.getInt2LabelMapping().save("/media/disk/Users/53590/Desktop/IIIT H/Bhaashik/Bhaashik new version/Bhaashik-17-05-09/data/automatic-annotation/SVM_Pos-tagging/17-06-labels.txt", ssf2svm.charset);
