...
import bhaashik.speech.decoder.isolated.IsolatedTrellisAligner;
...
//        apcProperties.setTransliterationCandidatesGenerator(isolatedTrellisAligner.getTransliterationCandidatesGenerator());
    ...
    {
        BhaashikTableModel srcWTTable = srcCorpus.getWordTypeTable();
        BhaashikTableModel tgtWTTable = tgtCorpus.getWordTypeTable();
