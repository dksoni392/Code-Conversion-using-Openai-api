...
public class ParallelMarkupAnalyzerJPanel extends javax.swing.JPanel
        implements WorkJPanelInterface, JPanelDialog, BhaashikClient {
    ...
    private void displayComparisonDetail() {
        ...
        switch(currentAnalysisType) {
            ...
            case ParallelMarkupAnalyzer.MARKUP_EXTENT:
                ...
                bhaashikTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(comparisonTable, selLanguage);
...
//		jt.setDefaultEditor()
    ...
    private void displayListDetail() {
        ...
        BhaashikTableModel listTable = null;
        ...
        switch(currentAnalysisType) {
            ...
            case ParallelMarkupAnalyzer.USED_MARKER_LIST:
                ...
                bhaashikTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(listTable, selLanguage);
                bhaashikTableJPanel.setSortable(true);
...
//		jt.setDefaultEditor()
    ...
    private void displayQueryDetail() {
        ...
        BhaashikTableModel queryTable = null;
        ...
        switch(currentAnalysisType) {
            case ParallelMarkupAnalyzer.MARKERS_QUERY:
                ...
                bhaashikTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(queryTable, selLanguage);
                bhaashikTableJPanel.setSortable(true);
...
//	{
//	    bhaashikTreeJPanel = new BhaashikTreeViewerJPanel(tree, BhaashikMutableTreeNode.MODIFIER_MODIFIED_MODE, language);
//	}
//	else
//	    bhaashikTreeJPanel = BhaashikTreeJPanel.createSSFDisplayJPanel(tree, language);
//
...
//	((CardLayout) detailJPanel.getLayout()).show(detailJPanel, "treeCard");
    ...
    public void analyze() {
        ...
        BhaashikTableModel summaryTable = null;
        ...
        summaryTableJPanel = BhaashikTableJPanel.createTableDisplayJPanel(summaryTable, parallelMarkupTasks[0].getLangEnc());
