...
//        srcTextJScrollPane.getVerticalScrollBar().setModel(tgtTextJScrollPane.getVerticalScrollBar().getModel());
    ...
    private void initComponents() {
        ...
        insertEmptySenJButton = new javax.swing.JButton();
        interchangeJButton1 = new javax.swing.JButton();
        ...
        combo_starImage.setMinimumSize(new java.awt.Dimension(72, 42));
        ...
        insertEmptySenJButton.setText("Insert Empty");
        insertEmptySenJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                insertEmptySenJButtonActionPerformed(evt);
            }
        });
        loadJPanel.add(insertEmptySenJButton);

        interchangeJButton1.setText("Interchange");
        loadJPanel.add(interchangeJButton1);
    ...
    private void insertEmptySenJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertEmptySenJButtonActionPerformed
        // TODO add your handling code here:
        int r = alignmentJTable.getSelectedRow();
        ...
        if(alignmentBlock.getMode() == AlignmentBlock.SENTENCE_ALIGNMENT_MODE)
        {
            if(c == 0)
            {
                alignmentBlock.incrementIndices(r, 1, false);
            }
            else if(c == 2)
            {
                alignmentBlock.incrementIndices(r, 1, true);                
            }
        }
        
        refreshAlignments(true);
    }//GEN-LAST:event_insertEmptySenJButtonActionPerformed
...
//        tableJTable.setIntercellSpacing(new java.awt.Dimension(5, 50));
        ...
        alignmentJTable.setSelectionForeground(new Color(255, 0, 0));
        alignmentJTable.firePropertyChange("selectionForegoundColorChanged", false, true);
        alignmentJTable.setSelectionBackground(new Color(200, 200, 255));
        alignmentJTable.firePropertyChange("selectionBackgoundColorChanged", false, true);
...
//            columnView.setIsMetric(false);
    ...
    private javax.swing.JButton insertEmptySenJButton;
    private javax.swing.JButton interchangeJButton1;
