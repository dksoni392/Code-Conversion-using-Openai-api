...
import bhaashik.tree.gui.SyntacticAlignmentTransferHandler;
...
public class ParallelSyntacticAnnotationWorkJPanel extends javax.swing.JPanel
    ...
    private void beginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_beginJButtonActionPerformed
        ...
        ((SyntacticAlignmentTransferHandler) srcWorkJPanel.getBhaashikTreeJPanel().getTransferHandler()).setTargetPanel(tgtWorkJPanel.getBhaashikTreeJPanel());
        ((SyntacticAlignmentTransferHandler) tgtWorkJPanel.getBhaashikTreeJPanel().getTransferHandler()).setTargetPanel(srcWorkJPanel.getBhaashikTreeJPanel());
...
//        srcWorkJPanel.getBhaashikTreeJPanel().setNodeTextEditable(true);
//        
//        tgtWorkJPanel.showBottomJPanel(false);
//        tgtWorkJPanel.showCommentJPanel(false);
//        tgtWorkJPanel.getBhaashikTreeJPanel().setNodeTextEditable(true);
