...
public class ParallelMarkupWorkJPanel extends javax.swing.JPanel
        implements WorkJPanelInterface, JPanelDialog, AnnotationClient {
...
//	((BhaashikTableJPanel) bhaashikTableJPanel).showCommandButtons(false);
    ...
    private void initComponents() {
        ...
        bhaashikTableJPanel.setLayout(new javax.swing.BoxLayout(bhaashikTableJPanel, javax.swing.BoxLayout.LINE_AXIS));
        ...
        bhaashikTableJPanel.add(markerMappingJScrollPane);
...
// TODO add your handling code here:
        ...
        BhaashikJDialog dialog = new BhaashikJDialog(owner, GlobalProperties.getIntlString("Bhaashik_Parellel_Markup_Task_Setup"), true, (JPanelDialog) selectTaskJPanel);
	dialog.pack();
...
//                ((BhaashikJTablePanel) bhaashikTableJPanel).getJTable().setRowSelectionInterval(i, i);
            }
        }
...
//            e.printStackTrace();
    ...
    private void tgtTMJComboBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tgtTMJComboBoxActionPerformed
        ...
        BhaashikTableModel srcSenMarkup = (BhaashikTableModel) parallelMarkupTask.getSrcSenMarkups().get(scurrentPosition);
        BhaashikTableModel tgtSenMarkup = (BhaashikTableModel) parallelMarkupTask.getTgtSenMarkups().get(scurrentPosition);
...
//        }
        ...
        tgtSenMarkup = (BhaashikTableModel) parallelMarkupTask.getTgtSenMarkups().get(scurrentPosition);
...
//
//        BhaashikTable srcSenMarkup = (BhaashikTable) srcSenMarkups.get(Integer.toString(pos + 1));
//
//        xml += "\t<SLSentence>\n";
...
//        xml += "\t</SLSentence>\n";
//
//        BhaashikTable tgtSenMarkup = (BhaashikTable) tgtSenMarkups.get(Integer.toString(pos + 1));
//
//        xml += "\t<TLSentence>\n";
...
//        xml += "\t</TLSentence>\n";
//
//        BhaashikTable markerIndexMapping = (BhaashikTable) markerMappingTables.get(Integer.toString(pos + 1));
//        BhaashikTable markerStringMapping = indexToStringMappingTable(markerIndexMapping);
//
//        xml += "\t<MarkerMapping>\n";
...
//        return xml;
    ...
    public javax.swing.JPanel bhaashikTableJPanel;
