...
import bhaashik.mlearning.mt.TransliterationCandidateGenerator;
...
public class APCProperties
{
	...
	public APCProperties(String f1, String f2)
	{
		...
		add("srcfile", f1);
		add("tgtfile", f2);
		add("dictpath", "/home/samar/bhaash/java/input/dict.dat");
		add("first_before_filter_map_file", "/home/samar/bhaash/java/output/algo_mapping_fbf");
		add("first_after_filter_map_file", "/home/samar/bhaash/java/output/algo_mapping_faf");
		add("second_before_filter_map_file", "/home/samar/bhaash/java/output/algo_mapping_sbf");
		add("second_after_filter_map_file", "/home/samar/bhaash/java/output/algo_mapping_saf");


		add("first_num_match", "/home/samar/bhaash/java/output/first_num_match");
		add("second_num_match", "/home/samar/bhaash/java/output/second_num_match");

		add("first_phntc_match", "/home/samar/bhaash/java/output/first_phntc_match");
		add("second_phntc_match", "/home/samar/bhaash/java/output/second_phntc_match");

		add("first_commwrd", "/home/samar/bhaash/java/output/first_commwrd");
		add("second_commwrd", "/home/samar/bhaash/java/output/second_commwrd");

		add("first_commhyp", "/home/samar/bhaash/java/output/first_commhyp");
		add("second_commhyp", "/home/samar/bhaash/java/output/second_commhyp");

		add("first_commsyn", "/home/samar/bhaash/java/output/first_commsyn");
		add("second_commsyn", "/home/samar/bhaash/java/output/second_commsyn");

		add("second_dwcorr", "/home/samar/bhaash/java/output/second_dwcorr");


		add("default_out_dir", "/home/samar/bhaash/java/output/");
		add("eng_morph_info", "/home/samar/bhaash/java/input/morph_flat.data");
		add("hnd_morph_info", "/home/samar/bhaash/java/input/hndtokens.dat.mo");
		add("eng_tokens", "/home/samar/bhaash/java/input/engtokens");
		add("hnd_tokens", "/home/samar/bhaash/java/input/hndtokens.dat");

		add("eng_mi_cutoff", "/home/samar/bhaash/java/input/corpus/MI/word_pair_mi.eng.out");
		add("hnd_mi_cutoff", "/home/samar/bhaash/java/input/corpus/MI/word_pair_mi.hnd.out");

		add("bi_pair_file", "/home/samar/bhaash/java/output/bi_pair_file.out");
		add("eng_wt", "/home/samar/bhaash/java/output/eng_wtype.out");
		add("hnd_wt", "/home/samar/bhaash/java/output/hnd_wtype.out");*/
