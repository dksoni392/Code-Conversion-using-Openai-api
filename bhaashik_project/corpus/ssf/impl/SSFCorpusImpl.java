...
public class SSFCorpusImpl extends Corpus
    ...
    List<SSFCorpusCollection> getContainerAlignable()
    {
        return null;
    }
    void setContainerAlignable(Alignable<T> alignmentUnit);
    T insertContainedAlignableObject(T containedAlignableObject, int atIndex);
    T removeContainedAlignableObject(int atIndex);
    T interchangeContainedAlignableObjects(T containedAlignableObject, int atIndex);
