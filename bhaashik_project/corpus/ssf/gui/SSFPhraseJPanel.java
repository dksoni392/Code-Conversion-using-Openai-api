...
import bhaashik.properties.gui.TKVPropertiesJPanel;
...
public class SSFPhraseJPanel extends javax.swing.JPanel
    ...
    private BhaashikTreeJPanel bhaashikTreeJPanel;
    ...
    public SSFPhraseJPanel(SSFPhrase ssp, boolean nestFS) {
        ...
        int cmds[] = new int[2];
//        cmds[0] = BhaashikTreeJPanel.COMBINE_NODES;
//        cmds[1] = BhaashikTreeJPanel.DEL_LAYER_CMD;
        cmds[0] = TreeAction.EXPAND_ALL;
        cmds[1] = TreeAction.COLLAPSE_ALL;
        
        BhaashikTreeModel bhaashikTreeModel = new BhaashikTreeModel(ssp);
//        bhaashikTreeJPanel = new BhaashikTreeJPanel(bhaashikTreeModel,
//                new SSFTreeCellRenderer(), cmds, BhaashikTreeJPanel.SSF_MODE);
...
// TODO add your handling code here:
        ...
        if (currentSelection != null) 
        {
            ...
            if(parent != null)
            {
                ...
                {
	            BhaashikTableModel table = fss.getAltFSValue(0).getFeatureTable();
                ...
                if(nestedFS == true)
                    ((FeatureStructureJPanel) featureStructureJPanel).getBhaashikTreeJPanel().expandAll(null);
