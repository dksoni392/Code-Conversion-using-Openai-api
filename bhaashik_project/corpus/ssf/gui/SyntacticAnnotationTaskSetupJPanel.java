        ...
        implements TaskSetupJPanelInterface, JPanelDialog
{
	...
	setDefaults();
        ...
        langauge = BhaashikLanguages.getLanguageName(langEnc);
        encoding = BhaashikLanguages.getEncodingName(langEnc);
...
// TODO add your handling code here:
	...
	BhaashikLanguages.fillEncodings(encodings, BhaashikLanguages.getLanguageCode(langauge));
        ...
        if(langauge != null)
            stateKVProps.addProperty("LangEnc", BhaashikLanguages.getLangEncCode(langauge, encoding));
