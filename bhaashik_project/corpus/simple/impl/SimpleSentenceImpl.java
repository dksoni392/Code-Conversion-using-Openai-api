...
import bhaashik.corpus.simple.data.impl.WordTypeExImpl;
import bhaashik.corpus.Sentence;
import bhaashik.corpus.parallel.APCData;
import bhaashik.corpus.parallel.APCProperties;
import bhaashik.corpus.simple.SentenceFeatures;
import bhaashik.corpus.simple.SimpleSentence;
import bhaashik.corpus.simple.data.WordType;
import bhaashik.corpus.simple.data.WordTypeEx;
...
public class SimpleSentenceImpl extends Sentence implements SimpleSentence, SentenceFeatures
{
    ...
    public void calculateSentenceLength(BhaashikTableModel wttbl)
    {
    ...
    public void calculateSignature(BhaashikTableModel wttbl)
    {
        String str = getSentenceString(wttbl);
	...
	public Vector getWords(BhaashikTableModel wttbl)
	{
		int c = countWords();
	...
	public String getSentenceString(BhaashikTableModel wttbl)
	{
		String ret = "";
		int c = countWords();
	...
	public String getWordString(int i, BhaashikTableModel wttbl)
	{
	...
	/*public double getCommonSynonyms(Sentence sen, APCData apcdata)
	{
		...
		for(i = 0; i < getWordCount(); i++)
		{
			...
			String file = "/home/samar/bhaash/java/output/synonyms_tmp.txt";
...
//////////////////////////////////////
    ...
    public void printCounts(BhaashikTableModel wtTable, PrintStream ps)
    {
