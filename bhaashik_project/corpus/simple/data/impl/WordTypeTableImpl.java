package bhaashik.corpus.simple.data.impl;

import java.io.*;
import java.util.*;

import bhaashik.data.attrib.impl.DefaultTypeTable;
import bhaashik.corpus.simple.data.*;
...
public class WordTypeTableImpl extends DefaultTypeTable implements WordTypeTable
{
	...
	public int addWT(WordType wt)
	{
		...
		word_index.put(key, Integer.valueOf(i));
