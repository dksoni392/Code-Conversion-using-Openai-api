...
import bhaashik.text.adhoc.AksharSimList;
...
//			System.out.println(temp+ " " + costList.get(i));
	...
	public void genFinalCost()
	{
		...
		for (i=0; i<countWords; i++)
		{
			...
			Double costDoub = Double.valueOf(costFinal);
...
//					Horizontal Cost
			...
			if (node.getFlags() == node.EOWORD)
			{
				if (endNodeList.contains(node) == false)
				{
					...
					Double costDoub = Double.valueOf(cost);
...
//					System.out.print(" " + countWords);
	...
	public static void main (String args[])
	{
		...
		try
		{
			DictionaryFST dict = new DictionaryFST(GlobalProperties.getHomeDirectory() + "/data/transliteration/wordList", GlobalProperties.getIntlString("UTF-8"), "/home/bhaash/tmp/spell-checker-dict.forward", "/home/bhaash/tmp/spell-checker-dict.reverse");
