...
public class NumberFilter {
    ...
    protected String convertLessThanOneThousand(long number)
    {
		...
		soFar = (String) minorW.getPropertyValue("" + Long.valueOf(number % 100L));
		number /= 100L;
		...
		String mw = (String) minorW.getPropertyValue("" + Long.valueOf(number));
