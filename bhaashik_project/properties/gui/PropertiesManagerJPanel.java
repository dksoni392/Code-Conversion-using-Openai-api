 ...
 * @author  anil
 */
public class PropertiesManagerJPanel extends javax.swing.JPanel implements BhaashikClient, JPanelDialog {
...
// TODO add your handling code here:
    ...
    private void showProperties() {
        ...
        if(selProperty.equals("") == false && selContainer.equals("") == false) {
            ...
            BhaashikProperties prop = propman.getPropertyContainer(selContainer, pt);
            ...
            try {
                ...
                if(v.size() != 1) {
                    JOptionPane.showMessageDialog(parentComponent, GlobalProperties.getIntlString("Error_in_Properties_Manager_file:_") + selContainer, GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
                    return;
                }
            ...
            try {
                if(pt == PropertyType.PROPERTY_TOKENS) {
                    ...
                    containerJPanel = new BhaashikTableJPanel(tableFile, charset, true, null, BhaashikTableJPanel.MINIMAL_MODE, GlobalProperties.getIntlString("hin::utf8"));
                }
