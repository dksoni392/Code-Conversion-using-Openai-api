...
package bhaashik.properties.gui;
...
public class SelectPropertiesManagerJPanel extends javax.swing.JPanel {
    ...
    private PropertiesTable bhaashikComponents;
    ...
    private void initComponents() {
        ...
        forBhaashikComponentJPanel = new javax.swing.JPanel();
        bhaashikComponentLabel = new javax.swing.JLabel();
        bhaashikComponentJComboBox = new javax.swing.JComboBox();
        ...
        selectFromJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bhaashik Component", "File" }));
        ...
        forBhaashikComponentJPanel.setLayout(new java.awt.BorderLayout());

        bhaashikComponentLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        bhaashikComponentLabel.setLabelFor(bhaashikComponentJComboBox);
        bhaashikComponentLabel.setText("Bhaashik component: ");
        bhaashikComponentLabel.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        forBhaashikComponentJPanel.add(bhaashikComponentLabel, java.awt.BorderLayout.WEST);
        forBhaashikComponentJPanel.add(bhaashikComponentJComboBox, java.awt.BorderLayout.CENTER);

        selectPMJPanel.add(forBhaashikComponentJPanel, "forBhaashik");
...
// TODO add your handling code here:
        ...
        if(selItem.equals(GlobalProperties.getIntlString("Bhaashik_Component")))
        {
            Vector v = bhaashikComponents.getValues("BhaashikComponent", bhaashikComponentJComboBox.getSelectedItem(), new String[] {"PMPath"});
            
            if(v.size() != 1 && ((Vector) v.get(0)).size() != 1)
            {
                JOptionPane.showMessageDialog(this, GlobalProperties.getIntlString("Error_in_Bhaashik_component_list."), GlobalProperties.getIntlString("Error"), JOptionPane.ERROR_MESSAGE);
                return;
            }
...
// TODO add your handling code here:
        ...
        if(selItem.equals(GlobalProperties.getIntlString("Bhaashik_Component")))
        {
            ((CardLayout) selectPMJPanel.getLayout()).show(selectPMJPanel, "forBhaashik");
        }
        else if(selItem.equals(GlobalProperties.getIntlString("File")))
        {
    ...
    public void setOwner(JFrame jframe)
    {
        ...
        Vector vt = bhaashikComponents.getColumn(GlobalProperties.getIntlString("BhaashikComponent"));
        DefaultComboBoxModel cm = new DefaultComboBoxModel(vt);
        bhaashikComponentJComboBox.setModel(cm);
    }
...
//            }
    ...
    {
        try {
            bhaashikComponents = new PropertiesTable(pmPath, charSet);
            bhaashikComponents.print(System.out);
    ...
    public javax.swing.JPanel forBhaashikComponentJPanel;
    ...
    public javax.swing.JComboBox bhaashikComponentJComboBox;
    public javax.swing.JLabel bhaashikComponentLabel;
