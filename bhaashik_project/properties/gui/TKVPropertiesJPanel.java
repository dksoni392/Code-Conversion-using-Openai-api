...
public class TKVPropertiesJPanel extends javax.swing.JPanel
            ...
            throws FileNotFoundException, IOException
    {
        ...
        BhaashikTableModel table = new BhaashikTableModel(f, charset);
    ...
    public TKVPropertiesJPanel(BhaashikTableModel table, boolean sortable, int appliedCommands[])
    {
        this.sortable = sortable;
    ...
    public TKVPropertiesJPanel(PropertyType pt, boolean sortable, int appliedCommands[]) {
        ...
        BhaashikTableModel table = new BhaashikTableModel();
        tableJTable.setModel(table);
...
// TODO add your handling code here:
    ...
    public void setSortable(boolean s)
    {
        ...
        if(sortable)
        {
            BhaashikTableModel table = (BhaashikTableModel) tableJTable.getModel();
        ...
        else
        {
            ...
            BhaashikTableModel table = (BhaashikTableModel) sorter.getTableModel();
            tableJTable.setModel(table);
        }
    }
    ...
    {
        return (BhaashikTableModel) ((TableSorter) tableJTable.getModel()).getTableModel();
    }
