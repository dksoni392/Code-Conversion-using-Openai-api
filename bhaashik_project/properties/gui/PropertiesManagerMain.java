...
//        currentJPanel.setVisible(true);
        ...
        ((SelectPropertiesManagerJPanel) selectPMJPanel).configure(GlobalProperties.getHomeDirectory() + "/" + "workspace/bhaash-components-pm.txt", GlobalProperties.getIntlString("UTF-8"));
        ((SelectPropertiesManagerJPanel) selectPMJPanel).setOwner(this);
        
//        try {
//            setWorkspace("/home/anil/myproj/bhaash/eclipse/Bhaashik/");
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
    }
