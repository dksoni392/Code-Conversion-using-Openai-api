...
public class TableDropTarget implements DropTargetListener {
    ...
    protected BhaashikTransferableObject transferable;
    
    protected BhaashikJTable targetTable;

    protected int mode;

    protected boolean dropEnded = true;
    
    public TableDropTarget(BhaashikJTable table, int mode) {
        targetTable = table;
   ...
   */
    private Object getDropObjectForEvent(DropTargetDragEvent dtde) {
        ...
        BhaashikJTable table = (BhaashikJTable) dtc.getComponent();
...
/////////
    ...
    //                        throw new Exception();
                        ...
                        {
                            BhaashikAlignableDataTransfer.transferData(targetTable, dragObject, dropObject, mode, dtde.getDropAction(), table, r, c);
...
//                            }
    ...
    //                  setLabel(dtde);
                    ...
                    else if(mode == BhaashikJTable.ALIGNMENT_MODE && dragObject instanceof AlignmentUnit
                  ...
                  if(dtde.getDropAction() == DnDConstants.ACTION_COPY)
                  {
                        ...
                        try {
                            if(treeNode instanceof SSFPhrase)
                                sourceNode = (SSFNode) dtde.getTransferable().getTransferData(BhaashikDataFlavors.SSF_PHRASE_FLAVOR);
                            else if(treeNode instanceof SSFLexItem)
                                sourceNode = (SSFNode) dtde.getTransferable().getTransferData(BhaashikDataFlavors.SSF_LEXITEM_FLAVOR);
