 ...
 */
public class PointLatticeJPanel extends javax.swing.JPanel implements BhaashikClient, JPanelDialog
{
...
//        pointLattice.makeLattice("खतरनाक", PointLattice.PHONETIC_SPACE_MODE);
        ...
        tableJTable = new BhaashikJTable(pointLattice.getGrid(), 5, pointLattice);
...
//        tableJTable.setIntercellSpacing(new java.awt.Dimension(5, 50));
        ...
        BhaashikEdges edges = pointLattice.getEdges();
