...
public class SSFFindReplace {
    ...
    public void setDefaults(PropertyTokens tagsPT,PropertyTokens namesPT,String enc, JFrame frame,BhaashikTreeJPanel panel)
    {
        posTagsPT = tagsPT;
    ...
    public BhaashikTableModel getFindOptionsTable()
    {
        ...
        BhaashikJDialog findDialog = new BhaashikJDialog(owner1, "Find", true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
    ...
    public BhaashikTableModel getReplaceOptionsTable()
    {
        ...
        BhaashikJDialog findDialog = new BhaashikJDialog(owner1, "Replace", true, (JPanelDialog) findOptionsJPanel);
        findDialog.pack();
            ...
            if(e.getType() == TableModelEvent.INSERT)
            {
                for (int i = 0; i < ccount; i++)
                {
                    ...
                    if(colName.equals("Create Attribute"))
                        model.setValueAt(Boolean.valueOf(false), row, i);
