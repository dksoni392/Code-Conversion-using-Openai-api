...
public class TreeViewNodeEditPopupListener extends MouseAdapter
{
     ...
     protected BhaashikTreeViewerJPanel bhaashikTreeViewerJPanel;
     protected List namedNodes;
     protected List attribNames;

     protected Point point;

     public TreeViewNodeEditPopupListener(BhaashikJTable bhaashikJTable, JPopupMenu pm, Hashtable nodeLabelEditors, BhaashikTableModel fsSchema) {
        popup = pm;
    ...
    public TreeViewNodeEditPopupListener(JPopupMenu pm, BhaashikTableModel fsSchema) {
        popup = pm;
...
//        featureDeleteJMenu = new JMenu("Delete Attribute");
    ...
    public void setBhaashikTreeJPanel(BhaashikTreeViewerJPanel bhaashikTreeViewerJPanel)
    {
        this.bhaashikTreeViewerJPanel = bhaashikTreeViewerJPanel;
    }
