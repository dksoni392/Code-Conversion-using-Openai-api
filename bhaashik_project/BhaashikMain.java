...
//        sshClientJPanel = (BhaashikSSHClientJPanel) createNewApplication(ClientType.BHAASHIK_SSH_CLIENT);
//        createNewApplication(ClientType.BHAASHIK_SHELL);
...
//        }
    ...
    {
        if(ctype.equals(ClientType.BHAASHIK_SSH_CLIENT) && remoteClientJPanel != null)
        {
...
////		ex.printStackTrace();
////	}
////        bhaashikServerRI = (BhaashikServerRI) ServerType.getNewServer(ServerType.BHAASHIK_SERVER, server, true);
...
//        bhaashikServerRI = (BhaashikServerRI) ServerType.getNewServer(ServerType.BHAASHIK_SERVER, "", false);
