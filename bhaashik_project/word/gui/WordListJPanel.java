...
public class WordListJPanel extends javax.swing.JPanel
         implements JPanelDialog, BhaashikClient {
	...
	languageJComboBox.setModel(langauges);
        languageJComboBox.setSelectedItem(BhaashikLanguages.getLanguageName(langEnc));
    }
...
// TODO add your handling code here:
        ...
        langEnc = BhaashikLanguages.getLanguageCode(langauge) + GlobalProperties.getIntlString("::utf8");
    ...
    {
        BhaashikJDialog fsDialog = (BhaashikJDialog) DialogFactory.showDialog(FileSelectionJPanel.class, owner, GlobalProperties.getIntlString("Select_Word_List_Sources"), true);
