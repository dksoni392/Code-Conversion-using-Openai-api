 ...
 */
package bhaashik.xml.validation;
 ...
 * @author anil
 */
public class BhaashikEntityResolver implements EntityResolver
{
    ...
    public BhaashikEntityResolver(String cs)
    {
        this();
    ...
    public BhaashikEntityResolver()
    {
        addMapping("-//Bhaashik//Frameset//EN", "./data/propbank/resource/frameset/frameset.dtd",
