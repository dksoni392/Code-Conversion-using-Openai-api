...
public class DictionaryEditorJPanel extends javax.swing.JPanel
    ...
    {//GEN-HEADEREND:event_srcLanguageJComboBoxActionPerformed
        ...
        BhaashikLanguages.fillEncodings(srcEncodings, BhaashikLanguages.getLanguageCode(srcLangauge));
        KeyValueProperties stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.DICTIONARY_EDITOR.toString());
...
//            UtilityFunctions.setComponentFont(tgtCellRenderer, tgtLangEnc);
    ...
    private static void saveState(DictionaryEditorJPanel editorInstance) {
        stateKVProps = BhaashikClientsStateData.getSateData().getPropertiesValue(ClientType.DICTIONARY_EDITOR.toString());
