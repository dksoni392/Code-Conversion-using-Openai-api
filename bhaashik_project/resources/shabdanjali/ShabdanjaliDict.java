...
implements ActionListener {
	...
	private bhaashik.resources.shabdanjali.Dictionary shabdanjali;
    ...
    {
        shabdanjali = new bhaashik.resources.shabdanjali.Dictionary();
...
//        shabdanjali.makeDictionary("shabdanjali.unicode");
	...
	public void populateTree(String word) {
		...
		if (entryList == null) {
			...
			String pos, meaning;
			BhaashikMutableTreeNode posNode, meanNode;
